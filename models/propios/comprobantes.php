...
class ComprobantesModel extends DbModel{
    ...
    public function read(){
        ...
        $zona = $_SESSION['zona'];
        $common = "SELECT fecha, clientes.nombre as cliente, usuarios.nombre as vendedor, comprobantes.estado, total, id_comprobante, clientes.tipo as tipo, usuarios.tipo as tipo_vendedor FROM comprobantes INNER JOIN clientes ON
